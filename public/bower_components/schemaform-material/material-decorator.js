...
$templateCache.put("decorators/material/array.html","<div class=\"schema-form-{{form.type}} {{form.htmlClass}}\" md-theme=\"dark\" sf-field-model=\"sf-new-array\" sf-new-array=\"$$value$$\"><div layout=\"row\" style=\"padding: 0;\" class=\"md-toolbar-tools\"><label class=\"control-label\" flex=\"\" ng-show=\"showTitle()\">{{ form.title }}</label><md-button class=\"md-icon-button\" aria-label=\"add\" ng-if=\"!modelArray || modelArray.length==0\" ng-hide=\"form.readonly || form.add === null\" ng-click=\"appendToArray()\" ng-disabled=\"form.schema.maxItems <= modelArray.length\"><ng-md-icon icon=\"add\"></ng-md-icon></md-button></div><md-list class=\"list-group\" ng-model=\"modelArray\" ui-sortable=\"form.sortOptions\"><md-list-item layout=\"row\" layout-padding=\"\" class=\"list-group-item md-whiteframe-3dp\" ng-repeat=\"item in modelArray track by $index\"><md-content flex=\"\" class=\"{{form.fieldHtmlClass}}\"><label style=\"margin: 5px;\">{{ (form.subTitle || form.title) + ($index+1) }}</label><sf-decorator ng-init=\"arrayIndex = $index; sectionClass = form.sectionClass\" flex=\"\" form=\"copyWithIndex($index)\"></sf-decorator></md-content><md-content layout=\"column\" flex=\"none\" flex-order=\"2\"><md-button class=\"md-icon-button\" aria-label=\"add\" ng-hide=\"form.readonly || form.add === null\" ng-click=\"appendToArray()\" ng-disabled=\"form.schema.maxItems <= modelArray.length\"><ng-md-icon icon=\"add\"></ng-md-icon></md-button><md-button class=\"md-icon-button\" aria-label=\"remove\" ng-hide=\"form.readonly || form.remove === null\" ng-click=\"deleteFromArray($index)\" ng-disabled=\"form.schema.minItems >= modelArray.length\"><ng-md-icon icon=\"delete\"></ng-md-icon></md-button></md-content></md-list-item></md-list></div>");
$templateCache.put("decorators/material/array1.html","<div class=\"schema-form-{{form.type}} {{form.htmlClass}}\" md-theme=\"dark\" sf-field-model=\"sf-new-array\" sf-new-array=\"\"><div layout=\"row\" style=\"padding: 0;\" class=\"md-toolbar-tools\"><label class=\"control-label\" flex=\"\" ng-show=\"showTitle()\">{{ form.title }}</label><md-button class=\"md-icon-button\" aria-label=\"add\" ng-if=\"!modelArray || modelArray.length==0\" ng-hide=\"form.readonly || form.add === null\" ng-click=\"appendToArray()\" ng-disabled=\"form.schema.maxItems <= modelArray.length\"><ng-md-icon icon=\"add\"></ng-md-icon></md-button></div><md-list class=\"list-group\" ng-model=\"modelArray\" ui-sortable=\"form.sortOptions\"><md-list-item layout=\"row\" layout-padding=\"\" class=\"list-group-item md-whiteframe-2dp\" sf-field-model=\"ng-repeat\" ng-repeat=\"item in $$value$$ track by $index\"><md-content flex=\"\" class=\"{{form.fieldHtmlClass}}\"><div layout-padding=\"\">{{ (form.subTitle || form.title) + ($index+1) }}</div><sf-decorator ng-init=\"arrayIndex = $index; sectionClass = form.sectionClass\" flex=\"\" form=\"copyWithIndex($index)\"></sf-decorator></md-content><md-content layout=\"column\" flex=\"none\" flex-order=\"2\"><md-button class=\"md-icon-button\" aria-label=\"add\" ng-hide=\"form.readonly || form.add === null\" ng-click=\"appendToArray()\" ng-disabled=\"form.schema.maxItems <= modelArray.length\"><ng-md-icon icon=\"add\"></ng-md-icon></md-button><md-button class=\"md-icon-button\" aria-label=\"remove\" ng-hide=\"form.readonly || form.remove === null\" ng-click=\"deleteFromArray($index)\" ng-disabled=\"form.schema.minItems >= modelArray.length\"><ng-md-icon icon=\"delete\"></ng-md-icon></md-button></md-content></md-list-item></md-list></div>");
$templateCache.put("decorators/material/autocomplete.html","<div class=\"form-group {{form.htmlClass}} schema-form-autocomplete\" sf-layout=\"\" ng-init=\"\"><md-autocomplete ng-disabled=\"form.readonly\" sf-autocomplete=\"\" sf-field-model=\"replaceAll\" ng-model=\"$$value$$\" ng-init=\"autoData={};form.init($$value$$,autoData,arrayIndex)\" schema-validate=\"form\" class=\"no-errors\" md-is-error=\"ngModel.$error && ngModel.$invalid\" md-input-minlength=\"{{ form.minInputLength || 1 }}\" md-autoselect=\"true\" md-input-name=\"{{form.key}}\" md-no-cache=\"form.noCache\" md-selected-item=\"autoData.selected\" md-search-text=\"autoData.searchText\" md-selected-item-change=\"form.onChange(item, form, model, modelArray, arrayIndex)\" md-items=\"item in form.query(autoData.searchText,modelArray,arrayIndex,$parent)\" md-item-text=\"item[form.textField]\" md-floating-label=\"{{ form.label }}\" placeholder=\"{{ form.placeholder }}\" md-menu-class=\"autocomplete-custom-template\"><md-item-template><div><span ng-if=\"!form.muti\" md-highlight-text=\"searchText\">{{ item[form.textField] }}</span> <span ng-if=\"form.muti\" md-highlight-text=\"searchText\" ng-repeat=\"key in form.muti\">{{ !$first ? (form.prefix || \'-\'):\'\' }} {{ item[key] }}</span></div></md-item-template><md-not-found>没有记录</md-not-found><div><div ng-messages=\"ngModel.$error\" aria-live=\"assertive\"><div sf-message=\"\" ng-message=\"\"></div></div><div class=\"md-char-counter\">{{ form.description }}</div></div></md-autocomplete></div>");
$templateCache.put("decorators/material/checkbox.html","<div class=\"checkbox schema-form-checkbox {{::form.htmlClass}}\"><md-checkbox sf-field-model=\"\" ng-model=\"$$value$$\" ng-disabled=\"form.readonly\" schema-validate=\"form\" sf-changed=\"form\" ng-model-options=\"form.ngModelOptions\" ng-true-value=\"{{form.trueValue || true}}\" ng-false-value=\"{{form.falseValue || false}}\" ng-class=\"form.fieldHtmlClass\" name=\"{{::form.key|sfCamelKey}}\" aria-label=\"{{::form.title}}\"><span>{{::form.title}}</span></md-checkbox><md-input-container md-is-error=\"!$root.isEmptyObject(ngModel.$error)\"><div ng-messages=\"ngModel.$error\" class=\"md-input-messages-animation\"><div sf-message=\"\" ng-message=\"\"></div></div><div class=\"md-char-counter\">{{ form.description }}</div></md-input-container></div>");
$templateCache.put("decorators/material/checkboxes.html","<div sf-array=\"form\" sf-field-model=\"\" class=\"form-group schema-form-checkboxes {{::form.htmlClass}}\" sf-messages=\"\"><div layout=\"row\" style=\"padding: 0;\" class=\"md-toolbar-tools\"><label class=\"control-label\" flex=\"\" ng-show=\"showTitle()\">{{ form.title }}</label></div><md-content ng-class=\"form.fieldHtmlClass\"><div class=\"checkbox\" ng-repeat=\"val in titleMapValues track by $index\"><md-checkbox ng-model=\"titleMapValues[$index]\" sf-changed=\"form\" ng-change=\"form.change(form.titleMap[$index],modelArray,model)\" ng-disabled=\"::form.readonly\" name=\"{{::form.key|sfCamelKey}}\" ng-true-value=\"true\" ng-false-value=\"false\" aria-label=\"{{::form.title}}\">{{::form.titleMap[$index].name}}</md-checkbox></div></md-content></div>");
$templateCache.put("decorators/material/chips.html","<md-input-container style=\"margin-top:0;\" md-no-float=\"true\" md-is-error=\"ngModel.$error && ngModel.$invalid\" class=\"schema-form-chips md-block {{::form.htmlClass}}\" sf-layout=\"\"><md-chips sf-field-model=\"\" ng-model=\"$$value$$\" class=\"no-errers\" placeholder=\"{{form.title}}\" secondary-placeholder=\"{{form.secondaryTitle||\'\'}}\" md-max-chips=\"10\" readonly=\"form.readonly\" flex=\"\"><md-chip-template><strong ng-if=\"!form.template\">{{$chip}}</strong></md-chip-template></md-chips><div class=\"md-errors-spacer\"></div><div ng-messages=\"ngModel.$error\" aria-live=\"assertive\"><div sf-message=\"\" ng-message=\"\"></div></div><div class=\"md-char-counter\">{{ form.description }}</div></md-input-container>");
...
$templateCache.put("decorators/material/select.html","<md-input-container md-is-error=\"ngModel.$error && ngModel.$invalid\" class=\"form-group md-block {{::form.htmlClass}} schema-form-select\" sf-layout=\"\"><label ng-show=\"::showTitle()\">{{::form.title}}</label><md-select sf-field-model=\"\" name=\"{{ ::form.key|sfCamelKey }}\" schema-validate=\"form\" ng-model=\"$$value$$\"><md-optgroup ng-repeat-start=\"(key, opt) in form.titleMap\" ng-if=\"opt.group && opt.group != optGroups[key-1].group\" label=\"{{::opt.group}}\" aria-label=\"{{::opt.group}}\"><md-option ng-repeat=\"(key, filtered) in form.titleMap\" ng-if=\"!!filtered.disabled\" ng-value=\"::filtered.value\" aria-label=\"{{::filtered.name}}\">{{::filtered.name}} <span ng-bind-html=\"filtered.template | trustHtml\"></span></md-option></md-optgroup><md-option ng-if=\"!opt.group\" ng-value=\"::opt.value\" ng-repeat-end=\"\">{{::opt.name}} <span ng-bind-html=\"opt.template | trustHtml\"></span></md-option></md-select><div class=\"md-errors-spacer\"></div><div ng-messages=\"ngModel.$error\"><div sf-message=\"\" ng-message=\"\"></div></div><div class=\"md-char-counter\">{{ form.description }}</div></md-input-container>");
...
$templateCache.put("decorators/material/textarea.html","<md-input-container class=\"{{::form.htmlClass}} schema-form-textarea md-block\" md-is-error=\"ngModel.$error && ngModel.$invalid\"><label ng-show=\"showTitle()\" for=\"{{::form.key|sfCamelKey}}\">{{::form.title}}</label> <textarea ng-class=\"::form.fieldHtmlClass\" id=\"{{::form.key|sfCamelKey}}\" sf-changed=\"form\" ng-disabled=\"::form.readonly\" ng-model=\"$$value$$\" sf-field-model=\"\" md-maxlength=\"form.maxLength\" schema-validate=\"form\" rows=\"{{ form.rows || 1 }}\" cols=\"{{ form.cols }}\" name=\"{{::form.key|sfCamelKey}}\"></textarea><div ng-messages=\"ngModel.$error\" aria-live=\"assertive\"><div sf-message=\"\" ng-message=\"\"></div></div><div class=\"md-char-counter\">{{ form.description }}</div></md-input-container>");}]);
(function (angular, undefined) {
    ...
    function materialDecoratorConfig(schemaFormProvider, decoratorsProvider, sfBuilderProvider, sfPathProvider, $injector) {
        ...
        decoratorsProvider.defineDecorator('materialDecorator', {
            ...
            chips: {template: base + 'chips.html', builder: arrays},

            chips1: {template: base + 'chips.html', builder: arrays},
            ...
            section: {template: base + 'section.html', builder: defaults},
        ...
        function mdAutocompleteBuilder(args) {
            ...
            if (mdAutocompleteFrag) {
                if (args.form.onChange) {
                    ...
                    mdAutocompleteFrag.setAttribute('md-search-text-change', 'form.query(searchText,modelArray,arrayIndex)');
                }
