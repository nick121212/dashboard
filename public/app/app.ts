...
import whiteTheme = require("themes/white");
...
class AppModule {
    ...
    initHttpInterceptor() {
        this.module.factory("errorInterceptor", ["$rootScope", "$q", ($rootScope:angular.IRootScopeService, $q:angular.IQService):any => {
            return {
                "request": (httpConfig) => {
                    let deferred, site = localStorage.getItem("site");
    ...
    initRoles($q, Permission, Restangular, $rootScope) {
    ...
    config() {
        this.module.config([
            ...
            ($stateProvider, $urlRouterProvider, $httpProvider, $mdThemingProvider, sfErrorMessageProvider, $locationProvider, schemaFormDecoratorsProvider, mdSideMenuSectionsProvider) => {
    ...
    run() {
        this.module.run([
            ...
            ($rootScope, Permission, Restangular, $q):void => {
                ...
                this.initRoles($q, Permission, Restangular, $rootScope);
